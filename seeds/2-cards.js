    ...
    return knex('cards').del()
        .then(function() {
            ...
            return knex('cards').insert([
                ...
                { id: 13, cardname: 'King', drink: 'Pour some of your drink into the circle', do: 'do1', image: '/images/c13.png' },
                { id: 14, cardname: 'Joker', drink: `Toilet card, or you can smoke if you're a smoker` do: 'do1', image: '/images/d01.png' }
            ]);
        });
};